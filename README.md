...
<p style="display: inline">
  ...
  <!-- バックエンドの言語一覧 -->
  <img src="https://img.shields.io/badge/-Ruby-CC0000.svg?logo=Ruby&style=for-the-badge">
  <!-- ミドルウェア一覧 -->
...
新潟県長岡市とあるDJスタジオ予約管理アプリ

<!-- プロジェクトについて -->

DJスタジオの利用に関して管理するような媒体が存在ないため作成をしてスタジオの予約管理Webサイトを通じて効率化
を目指したい。
